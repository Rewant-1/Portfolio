...
export const navItems = [
  ...
  export const testimonials = [
    {
      quote:
        "Collaborating with Chike was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Chike's enthusiasm for every facet of development truly stands out. If you're seeking to elevate your website and elevate your brand, Chike is the ideal partner.",
